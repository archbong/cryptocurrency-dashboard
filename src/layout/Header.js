        ...
        <ErrorBoundary>
            ...
            >
                <Toolbar sx={{ minHeight: 70 }}>
                    ...
                    <Link to='/' style={{ textDecoration: 'none' }}>
                        <Box>
                            ...
                            {loading ? (
                                ...
                                >
                                    {loading ? (<Skeleton variant='text' width={300} />) : (`Cryptocurrency Dashboard`)}
                                </Typography>
                            </IconButton>
                        </Box>
                    </Link>
                    ...
                    >
                        {loading ? (<Skeleton variant='text' width={70} height={50} />)
                            : (
                        ...
                        {loading ? (<Skeleton variant='text' width={70} height={50} />)
                            : (
                                <CustomButton href={'/wallet'} icon={<WalletIcon />} text={'Wallet'} />
                            )
                        }
                        {/* <CustomButton href={'/user'} icon={<UserIcon />} text={'User'} /> */}
                        {loading ? (<Skeleton variant='text' width={70} height={50} />)
                            : (

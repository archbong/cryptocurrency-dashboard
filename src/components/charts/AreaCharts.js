...
const AreaCharts = () => {
    ...
    const data = {
        ...
        // take top ten result using slice
        // and then map
        labels: chartData
        ...
        datasets: [
            {
                ...
                pointBorderColor: alpha(theme.palette.primary.main),
                pointHoverRadius: 3,
    ...
    return (
        <ErrorBoundary>
            <Card>
                <ErrorBoundary>
                    <CardHeader
                        title='Top 10 Cryptocurrency by All-Time-High'
                        subheader='Top 10 Cryptocurrency Measured By Their All-Time-High (ATH)'
                    />
                </ErrorBoundary>
                <ErrorBoundary>
                    <Divider />
